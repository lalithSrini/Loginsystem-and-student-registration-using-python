...
Label(root,text="Email: lalithsrinivas.t@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Class = Combobox(obj,values=['1','2','3','4','5','6','6','7','8','9','10','11','12'],font="Roboto 10",width=17,state='r')
